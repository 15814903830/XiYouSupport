 ...
 * @DATE : 2019-07-25/23:17
 * @Description: 创建
 */
public class RongCreateGroup {

    public static String CreateGroup(List<ChatCreteEntity> userId, String groupId, String groupName) {
        ...
        for (int i = 0; i < userId.size(); i++) {
            nameValuePair.add(new BasicNameValuePair("userId", String.valueOf(userId.get(i).getMemberId())));
        }
