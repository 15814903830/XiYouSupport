 ...
 * @DATE : 2019-07-24/20:54
 * @Description:
 */
public class RongGetToken {


    public static String GetRongCloudToken(String id, String nickName, String portraitUri) {
