 ...
 * @Description: 我的接单
 */
public class MineTakingOrderFragment extends BaseFragment {
    View mView;
    ...
    private void initTab() {
        ...
        mOrderTabLayout.setIndicatorLineColor(R.color.colorAccent);
    }
    ...
    public void switchFragment(int id) {
        ...
        switch (id) {
            case R.id.menu_all:
                fragment = MineOrderAllFragment.getInstance(APPContents.TO_TAKING);
                break;
            case R.id.menu_no_started:
                fragment = MineNotStartedFragment.getInstance(APPContents.TO_TAKING);
                break;
            case R.id.menu_ongoing:
                fragment = MineOngoingFragment.getInstance(APPContents.TO_TAKING);
                break;
            case R.id.menu_unproved:
                fragment = MineUnprovedFragment.getInstance(APPContents.TO_TAKING);
                break;
            case R.id.menu_completed:
                fragment = MineCompleteFragment.getInstance(APPContents.TO_TAKING);
                break;
