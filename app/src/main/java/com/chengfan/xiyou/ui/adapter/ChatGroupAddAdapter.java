 ...
 * @DATE : 2019-07-26/02:07
 * @Description:
 */
public class ChatGroupAddAdapter extends BaseRVAdapter<ChatCreteEntity, BaseViewHolder> {

    public static HashMap<Integer, Boolean> isSelected;

    public ChatGroupAddAdapter(int layoutResId, @Nullable List<ChatCreteEntity> data) {
    ...
    private ChatCreateGroupAdapter.OnItemSelectedListener mSelectedListener;

    public void setSelectedListener(ChatCreateGroupAdapter.OnItemSelectedListener selectedListener) {
