 ...
 * @Description: 待开始
 */
public class MinePlaceNoStartAdapter extends BaseRVAdapter<MineOrderPlaceEntity, BaseViewHolder> {


    public MinePlaceNoStartAdapter(int layoutResId, @Nullable List<MineOrderPlaceEntity> data) {
