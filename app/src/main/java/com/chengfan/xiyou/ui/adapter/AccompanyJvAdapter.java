...
public class AccompanyJvAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        mXiYouBeanList.add(new XiYouBean(R.drawable.accompany_heping, "和平精英", "1"));
        mXiYouBeanList.add(new XiYouBean(R.drawable.accompany_wangzhe, "王者荣耀", "1"));
        mXiYouBeanList.add(new XiYouBean(R.drawable.accompany_pubg, "绝地求生", "1"));
        mXiYouBeanList.add(new XiYouBean(R.drawable.accompany_lol, "LOL", "1"));
        mXiYouBeanList.add(new XiYouBean(R.drawable.accompany_music, "音乐", "2"));
        mXiYouBeanList.add(new XiYouBean(R.drawable.accompany_apex, "堡垒之夜", "2"));
        mXiYouBeanList.add(new XiYouBean(R.drawable.accompany_peiliao, "陪聊倾诉", "2"));
        mXiYouBeanList.add(new XiYouBean(R.drawable.accompany_hongshui, "哄睡FM", "2"));
        mXiYouBeanList.add(new XiYouBean(R.drawable.accompany_more, "更多", "1"));
