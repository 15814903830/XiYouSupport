...
public class NineGridView extends ViewGroup {
    ...
    private int mIcDelete = R.drawable.ic_ninegrid_image_delete;
    ...
    public void addDataList(List<NineGridBean> dataList) {
        ...
        //Logger.d("NineGridView list size :" + mDataList.size() + "  list : " + mDataList + " addData  " + dataList);
        if (dataList.size() <= cha)
            mDataList.addAll(dataList);
        else
            mDataList.addAll(dataList.subList(0, cha - 1));

      //  Logger.d(" list size :" + mDataList.size() + "  list : " + mDataList + " addData  " + dataList);
     ...
     * Add data source
     */
    public void addData(List<NineGridBean> dataList) {
        if (mDataList.size() > mMaxNum)
            return;
        //Not allowed to exceed the maximum number
      //  int cha = mMaxNum - mDataList.size();
