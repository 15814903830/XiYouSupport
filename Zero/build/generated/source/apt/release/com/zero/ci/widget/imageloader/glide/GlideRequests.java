...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.zero.ci.widget.imageloader.glide.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.zero.ci.widget.imageloader.glide.GlideOptions().apply(toSet));
    }
  }
}
