package com.zero.ci.network.zrequest.conver.loading.text;
...
import com.zero.ci.network.zrequest.conver.loading.ZLoadingBuilder;


public class TextBuilder extends ZLoadingBuilder {
    private static final int BASE_ALPHA = 100;
    private static final String DEFAULT_TEXT = "Zero";
