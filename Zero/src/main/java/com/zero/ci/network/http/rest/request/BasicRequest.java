...
import com.zero.ci.network.http.rest.headers.Params;
import com.zero.ci.network.http.rest.headers.RedirectHandler;
import com.zero.ci.network.http.rest.headers.UserAgent;
import com.zero.ci.network.http.ssl.SSLUtils;
import com.zero.ci.network.http.tools.CounterOutputStream;
import com.zero.ci.network.http.tools.HeaderUtils;
import com.zero.ci.network.http.tools.IOUtils;
import com.zero.ci.network.http.MultiValueMap;
...
public class BasicRequest<T extends BasicRequest> implements Comparable<BasicRequest>, Startable, Cancelable, Finishable {
     ...
     * <pre>
     *     String url = "http://www.xxx.com/xx";
     *     StringRequest req = new StringRequest(url);
     *     req.path(123);
     *     ...
     * </pre>
     * The real url of Request is: http://www.xxx.com/xx/123
     */
     ...
     *     ...
     * </pre>
     * The real url of Request is: http://www.xxx.com/xx/456
     */
     ...
     *     ...
     * </pre>
     * The real url of Request is: http://www.xxx.com/xx/true
     */
     ...
     *     ...
     * </pre>
     * The real url of Request is: http://www.xxx.com/xx/a
     */
     ...
     *     ...
     * </pre>
     * The real url of Request is: http://www.xxx.com/xx/456.99
     */
     ...
     *     ...
     * </pre>
     * The real url of Request is: http://www.xxx.com/xx/456.5
     */
     ...
     *     ...
     * </pre>
     * The real url of Request is: http://www.xxx.com/xx/oo
     */
        ...
        for (String key : keys) {
            ...
            for (Object value : values) {
                if (value instanceof String) {
                    ...
                    if (!(writer instanceof CounterOutputStream))
                        builder.append("\n").append(key).append(" is Binary ").append("\n");
