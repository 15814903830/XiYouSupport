package com.zero.ci.widget.logger;

import android.support.annotation.NonNull;
import android.support.annotation.Nullable;

import com.zero.ci.widget.logger.adapter.LogAdapter;
...
import static com.zero.ci.widget.logger.Logger.ASSERT;
import static com.zero.ci.widget.logger.Logger.DEBUG;
import static com.zero.ci.widget.logger.Logger.ERROR;
import static com.zero.ci.widget.logger.Logger.INFO;
import static com.zero.ci.widget.logger.Logger.VERBOSE;
import static com.zero.ci.widget.logger.Logger.WARN;
...
public class LoggerPrinter implements Printer {
  ...
  @Override public void d(@Nullable Object object) {
    log(DEBUG, null, LoggerUtils.toString(object));
  }
  ...
  @Override public synchronized void log(int priority,
    ...
    if (throwable != null && message != null) {
      message += " : " + LoggerUtils.getStackTraceString(throwable);
    }
    if (throwable != null && message == null) {
      message = LoggerUtils.getStackTraceString(throwable);
    }
    if (LoggerUtils.isEmpty(message)) {
