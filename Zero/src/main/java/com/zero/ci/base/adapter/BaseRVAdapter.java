...
import com.zero.ci.base.adapter.animation.AlphaInAnimation;
import com.zero.ci.base.adapter.animation.BaseAnimation;
import com.zero.ci.base.adapter.animation.ScaleInAnimation;
import com.zero.ci.base.adapter.animation.SlideInBottomAnimation;
import com.zero.ci.base.adapter.animation.SlideInLeftAnimation;
import com.zero.ci.base.adapter.animation.SlideInRightAnimation;
...
public abstract class BaseRVAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
     ...
     */
    private static final int ALPHAIN = 0x00000001;
    /**
     * Use with {@link #openLoadAnimation}
     */
    private static final int SCALEIN = 0x00000002;
    /**
     * Use with {@link #openLoadAnimation}
     */
    private static final int SLIDEIN_BOTTOM = 0x00000003;
    /**
     * Use with {@link #openLoadAnimation}
     */
    private static final int SLIDEIN_LEFT = 0x00000004;
    /**
     * Use with {@link #openLoadAnimation}
     */
    private static final int SLIDEIN_RIGHT = 0x00000005;
    ...
    /**
     * If you have added header view, the notification view refreshes.
     * Do not need to care about the number of header view, only need to pass in the position of the final view
     *
    ...
    public void setOnItemClick(View v, int position) {
        getOnItemClickListener().onItemClick(BaseRVAdapter.this, v, position);
    }
    ...
    public boolean setOnItemLongClick(View v, int position) {
        return getOnItemLongClickListener().onItemLongClick(BaseRVAdapter.this, v, position);
    }
    ...
    /**
     * When the current adapter is empty, the  BaseRVAdapter can display a special view
